...
extern void LCD_wave_display(Site_t site1,Site_t site2,Site_t site,Size_t size,uint8 *img,uint8 fazhi,uint8 fazhi2,uint8 maxval,uint16 Color);         //波形显示，不带背景颜色
